...
def test_stooq_data_module():
    ...
    try:
        from stooq_data import get_stock_info, get_historical_data, get_multiple_stock_info
        ...
        print(f"❌ Error testing stooq_data module: {e}")
        traceback.print_exc()
        return False
...
def test_edge_cases():
    ...
    try:
        ...
        from stooq_data import get_multiple_stock_info
...
def main():
    ...
    # Run test modules
    test_results = [
        ("Stooq Data Module", test_stooq_data_module()),
